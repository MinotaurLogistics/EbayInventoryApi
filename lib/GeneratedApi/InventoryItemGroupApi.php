...
class InventoryItemGroupApi
{
     ...
     * @param  \Swagger\EbayInventoryClient\Model\InventoryItemGroup $inventory_item_group Details of the inventory Item Group (required)
     *
     ...
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayInventoryClient\Model\InventoryItemGroup
     */
     ...
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayInventoryClient\Model\InventoryItemGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryItemGroupWithHttpInfo($inventory_item_group_key)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\InventoryItemGroup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\InventoryItemGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayInventoryClient\Model\InventoryItemGroup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayInventoryClient\Model\InventoryItemGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
