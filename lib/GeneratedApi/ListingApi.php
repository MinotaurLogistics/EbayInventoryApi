...
class ListingApi
{
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\BulkMigrateListing $bulk_migrate_listing Details of the listings that needs to be migrated into Inventory (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse
     */
     ...
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkMigrateListingWithHttpInfo($bulk_migrate_listing)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse',
