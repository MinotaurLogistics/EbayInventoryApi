...
class ProductCompatibilityApi
{
     ...
     * @param  \Swagger\EbayInventoryClient\Model\Compatibility $compatibility Details of the compatibility (required)
     *
     ...
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayInventoryClient\Model\Compatibility
     */
     ...
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\EbayInventoryClient\Model\Compatibility, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductCompatibilityWithHttpInfo($sku)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\Compatibility' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\Compatibility', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Swagger\EbayInventoryClient\Model\Compatibility';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\EbayInventoryClient\Model\Compatibility',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
