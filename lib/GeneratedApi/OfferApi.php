...
class OfferApi
{
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\BulkEbayOfferDetailsWithKeys $bulk_ebay_offer_details_with_keys Details of the offer for the channel (required)
     *
    ...
    public function bulkCreateOfferWithHttpInfo($bulk_ebay_offer_details_with_keys)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\BulkOfferResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\BulkOfferResponse', []),
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\BulkOffer $bulk_offer The base request of the bulkPublishOffer method. (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function bulkPublishOfferWithHttpInfo($bulk_offer)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\BulkPublishResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\BulkPublishResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  \Swagger\EbayInventoryClient\Model\EbayOfferDetailsWithKeys $ebay_offer_details_with_keys Details of the offer for the channel (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function createOfferWithHttpInfo($content_language, $ebay_offer_details_with_keys)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Swagger\EbayInventoryClient\Model\OfferResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\OfferResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\OfferKeysWithId $offer_keys_with_id List of offers that needs fee information (optional)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getListingFeesWithHttpInfo($offer_keys_with_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\FeesSummaryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\FeesSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\EbayOfferDetailsWithAll' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\EbayOfferDetailsWithAll', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getOffersWithHttpInfo($format = null, $limit = null, $marketplace_id = null, $offset = null, $sku = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\Offers' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\Offers', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function publishOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\PublishResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\PublishResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\PublishByInventoryItemGroupRequest $publish_by_inventory_item_group_request The identifier of the inventory item group to publish and the eBay marketplace where the listing will be published is needed in the request payload. (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayInventoryClient\Model\PublishResponse
     ...
     * @param  \Swagger\EbayInventoryClient\Model\EbayOfferDetailsWithId $ebay_offer_details_with_id Details of the offer for the channel (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\EbayInventoryClient\Model\OfferResponse
    ...
    public function withdrawOfferWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\EbayInventoryClient\Model\WithdrawResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\EbayInventoryClient\Model\WithdrawResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  \Swagger\EbayInventoryClient\Model\WithdrawByInventoryItemGroupRequest $withdraw_by_inventory_item_group_request The base request of the withdrawOfferByInventoryItemGroup call. (required)
     *
     * @throws \Swagger\EbayInventoryClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
