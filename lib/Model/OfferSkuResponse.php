...
class OfferSkuResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $errors This container will be returned at the offer level, and will contain one or more errors if any occurred with the attempted creation of the corresponding offer.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $warnings This container will be returned at the offer level, and will contain one or more warnings if any occurred with the attempted creation of the corresponding offer. Note that it is possible that an offer can be created successfully even if one or more warnings are triggered.
     *
     * @return self
     */
