...
class BulkPriceQuantityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'responses' => '\Swagger\EbayInventoryClient\Model\PriceQuantityResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \Swagger\EbayInventoryClient\Model\PriceQuantityResponse[]|null
     */
     ...
     * Sets responses
     *
     * @param \Swagger\EbayInventoryClient\Model\PriceQuantityResponse[]|null $responses This container will return an HTTP status code, offer ID, and SKU value for each offer/inventory item being updated, as well as an errors and/or warnings container if any errors or warnings are triggered while trying to update those offers/inventory items.
     *
     * @return self
     */
