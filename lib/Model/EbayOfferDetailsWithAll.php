...
class EbayOfferDetailsWithAll implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'listing' => '\Swagger\EbayInventoryClient\Model\ListingDetails',
     ...
     *
     * @param int $available_quantity This integer value indicates the quantity of the inventory item (specified by the sku value) that will be available for purchase by buyers shopping on the eBay site specified in the marketplaceId field. For unpublished offers where the available quantity has yet to be set, the availableQuantity value is set to 0.
     *
     * @return $this
     */
     ...
     * Sets format
     *
     * @param string $format This enumerated value indicates the listing format of the offer. Currently, the only supported value for this field is FIXED_PRICE. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:FormatTypeEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Gets listing
     *
     * @return \Swagger\EbayInventoryClient\Model\ListingDetails
     */
     ...
     * Sets listing
     *
     * @param \Swagger\EbayInventoryClient\Model\ListingDetails $listing listing
     *
     * @return $this
     */
     ...
     *
     * @param string $listing_description The description of the eBay listing that is part of the unpublished or published offer. This field is always returned for published offers, but is only returned if set for unpublished offers. Max Length: 500000 (which includes HTML markup/tags)
     *
     * @return $this
     */
     ...
     * Sets offer_id
     *
     * @param string $offer_id The unique identifier of the offer. This identifier is used in many offer-related calls, and it is also used in the bulkUpdatePriceQuantity call.
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string $sku This is the seller-defined SKU value of the product in the offer. Max Length: 50
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status The enumeration value in this field specifies the status of the offer - either PUBLISHED or UNPUBLISHED. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:OfferStatusEnum'>eBay API documentation</a>
     *
     * @return $this
     */
