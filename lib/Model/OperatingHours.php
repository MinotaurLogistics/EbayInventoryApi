...
class OperatingHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets intervals
     *
     * @return \Swagger\EbayInventoryClient\Model\Interval[]|null
     */
     ...
     * Sets intervals
     *
     * @param \Swagger\EbayInventoryClient\Model\Interval[]|null $intervals This container is used to define the opening and closing times of a store's working day (defined in the dayOfWeekEnum field). An intervals container is needed for each day of the week that the store location is open. If a store location closes for lunch (or any other period during the day) and then reopens, multiple open and close pairs are needed This container is returned if operating hours are defined for the store location.
     *
     * @return self
     */
