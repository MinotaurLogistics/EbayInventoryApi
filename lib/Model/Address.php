...
class Address implements ModelInterface, ArrayAccess
{
     ...
     * Sets country
     *
     * @param string $country The country in which the address resides, represented as two-letter ISO 3166 country code. For example, US represents the United States, and DE represents Germany. Max length: 2 For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/CountryCodeEnum\"'>eBay API documentation</a>
     *
     * @return $this
     */
