...
class OfferKeyWithId implements ModelInterface, ArrayAccess
{
     ...
     * Sets offer_id
     *
     * @param string $offer_id The unique identifier of an unpublished offer for which expected listing fees will be retrieved. One to 250 offerId values can be passed in to the offers container for one getListingFees call. Errors will occur if offerId values representing published offers are passed in.
     *
     * @return $this
     */
