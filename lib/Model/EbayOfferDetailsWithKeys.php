...
class EbayOfferDetailsWithKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets charity
     *
     * @return \Swagger\EbayInventoryClient\Model\Charity|null
     */
     ...
     * Sets charity
     *
     * @param \Swagger\EbayInventoryClient\Model\Charity|null $charity charity
     *
     * @return self
     */
     ...
     * Sets format
     *
     * @param string|null $format This enumerated value indicates the listing format of the offer. Supported values are FIXED_PRICE and AUCTION. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:FormatTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_catalog_product_details This field indicates whether or not eBay product catalog details are applied to a listing. A value of true indicates the listing corresponds to the eBay product associated with the provided product identifier. The product identifier is provided in createOrReplaceInventoryItem. Default: true Note: Though the includeCatalogProductDetails parameter is not required to be submitted in the request, the parameter defaults to true if omitted.
     *
     * @return self
     */
     ...
     *
     * @return \Swagger\EbayInventoryClient\Model\ListingPolicies|null
     */
     ...
     *
     * @param \Swagger\EbayInventoryClient\Model\ListingPolicies|null $listing_policies listing_policies
     *
     * @return self
     */
     ...
     *
     * @return \Swagger\EbayInventoryClient\Model\PricingSummary|null
     */
     ...
     *
     * @param \Swagger\EbayInventoryClient\Model\PricingSummary|null $pricing_summary pricing_summary
     *
     * @return self
     */
     ...
     * Gets tax
     *
     * @return \Swagger\EbayInventoryClient\Model\Tax|null
     */
     ...
     * Sets tax
     *
     * @param \Swagger\EbayInventoryClient\Model\Tax|null $tax tax
     *
     * @return self
     */
