...
class WithdrawByInventoryItemGroupRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets marketplace_id
     *
     * @param string $marketplace_id This is the unique identifier of the eBay site for which the offer will be made available. The marketPlaceId enumeration values are found in MarketplaceIdEnum. This field is required. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:MarketplaceEnum'>eBay API documentation</a>
     *
     * @return $this
     */
