...
class InventoryItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $errors This container will be returned if there were one or more errors associated with the creation or update to the inventory item record.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $warnings This container will be returned if there were one or more warnings associated with the creation or update to the inventory item record.
     *
     * @return self
     */
