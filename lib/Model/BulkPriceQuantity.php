...
class BulkPriceQuantity implements ModelInterface, ArrayAccess
{
     ...
     * Gets requests
     *
     * @return \Swagger\EbayInventoryClient\Model\PriceQuantity[]
     */
     ...
     * Sets requests
     *
     * @param \Swagger\EbayInventoryClient\Model\PriceQuantity[] $requests This container is used by the seller to update the total 'ship-to-home' quantity of one or more inventory items (up to 25) and/or to update the price and/or quantity of one or more specific published offers.
     *
     * @return $this
     */
