...
class InventoryLocationFull implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'location' => '\Swagger\EbayInventoryClient\Model\LocationDetails',
     ...
     * Gets location
     *
     * @return \Swagger\EbayInventoryClient\Model\LocationDetails
     */
     ...
     * Sets location
     *
     * @param \Swagger\EbayInventoryClient\Model\LocationDetails $location location
     *
     * @return $this
     */
     ...
     *
     * @param string $location_additional_information This text field is used by the merchant to provide additional information about an inventory location. Max length: 256
     *
     * @return $this
     */
     ...
     *
     * @param string $location_web_url This text field is used by the merchant to provide the Website address (URL) associated with the inventory location. Max length: 512
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\EbayInventoryClient\Model\OperatingHours[] $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A dayOfWeekEnum field and an intervals container will be needed for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone Although not technically required, this field is highly recommended to be used to specify the phone number for a store inventory location. Max length: 36
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \Swagger\EbayInventoryClient\Model\SpecialHours[] $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return $this
     */
