...
class InventoryLocationFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets location
     *
     * @return \Swagger\EbayInventoryClient\Model\LocationDetails|null
     */
     ...
     * Sets location
     *
     * @param \Swagger\EbayInventoryClient\Model\LocationDetails|null $location location
     *
     * @return self
     */
     ...
     *
     * @return \Swagger\EbayInventoryClient\Model\OperatingHours[]|null
     */
     ...
     *
     * @param \Swagger\EbayInventoryClient\Model\OperatingHours[]|null $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A dayOfWeekEnum field and an intervals container will be needed for each day of the week that the store location is open.
     *
     * @return self
     */
     ...
     * Gets special_hours
     *
     * @return \Swagger\EbayInventoryClient\Model\SpecialHours[]|null
     */
     ...
     * Sets special_hours
     *
     * @param \Swagger\EbayInventoryClient\Model\SpecialHours[]|null $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return self
     */
