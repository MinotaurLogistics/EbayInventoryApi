...
class InventoryLocationResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'location' => '\Swagger\EbayInventoryClient\Model\Location',
        ...
        'name' => 'string',
        'operating_hours' => '\Swagger\EbayInventoryClient\Model\OperatingHours[]',
        'phone' => 'string',
        'special_hours' => '\Swagger\EbayInventoryClient\Model\SpecialHours[]'
    ];
     ...
     * Gets location
     *
     * @return \Swagger\EbayInventoryClient\Model\Location
     */
     ...
     * Sets location
     *
     * @param \Swagger\EbayInventoryClient\Model\Location $location location
     *
     * @return $this
     */
     ...
     *
     * @param string $location_additional_information This text field provides additional information about an inventory location. This field is returned if it is set for the inventory location. Max length: 256
     *
     * @return $this
     */
     ...
     *
     * @param string $location_web_url This text field shows the Website address (URL) associated with the inventory location. This field is returned if defined for the inventory location. Max length: 512
     *
     * @return $this
     */
     ...
     *
     * @param string $merchant_location_key The unique identifier of the inventory location. This identifier is set up by the merchant when the inventory location is first created with the createInventoryLocation call. Once this value is set for an inventory location, it cannot be modified. Max length: 36
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\EbayInventoryClient\Model\OperatingHours[]
     */
     ...
     *
     * @param \Swagger\EbayInventoryClient\Model\OperatingHours[] $operating_hours This container shows the regular operating hours for a store location during the days of the week. A dayOfWeekEnum field and an intervals container is shown for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone The phone number for an inventory location. This field will typically only be set and returned for store locations. Max length: 36
     *
     * @return $this
     */
     ...
     * Gets special_hours
     *
     * @return \Swagger\EbayInventoryClient\Model\SpecialHours[]
     */
     ...
     * Sets special_hours
     *
     * @param \Swagger\EbayInventoryClient\Model\SpecialHours[] $special_hours This container shows the special operating hours for a store location on a specific date or dates.
     *
     * @return $this
     */
