...
class PriceQuantityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $errors This array will be returned if there were one or more errors associated with the update to the offer or inventory item record.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[]|null $warnings This array will be returned if there were one or more warnings associated with the update to the offer or inventory item record.
     *
     * @return self
     */
