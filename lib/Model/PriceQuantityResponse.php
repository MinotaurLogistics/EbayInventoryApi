...
class PriceQuantityResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[] $errors This array will be returned if there were one or more errors associated with the update to the offer or inventory item record.
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string $sku This is the seller-defined SKU value of the product. This field is returned whether the seller attempted to update an offer with the SKU value or just attempted to update the total 'ship-to-home' quantity of an inventory item record. Max Length: 50
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\EbayInventoryClient\Model\Error[] $warnings This array will be returned if there were one or more warnings associated with the update to the offer or inventory item record.
     *
     * @return $this
     */
