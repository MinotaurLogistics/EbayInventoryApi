...
class BulkOffer implements ModelInterface, ArrayAccess
{
     ...
     * Sets requests
     *
     * @param \Swagger\EbayInventoryClient\Model\OfferKeyWithId[] $requests This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one bulkPublishOffer method.
     *
     * @return $this
     */
