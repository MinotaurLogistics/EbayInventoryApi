...
```php
createOrReplaceProductCompatibility($content_language, $sku, $compatibility): \Swagger\EbayInventoryClient\Model\BaseResponse
```
...
$compatibility = new \Swagger\EbayInventoryClient\Model\Compatibility(); // \Swagger\EbayInventoryClient\Model\Compatibility | Details of the compatibility
 ...
 **compatibility** | [**\Swagger\EbayInventoryClient\Model\Compatibility**](../Model/Compatibility.md)| Details of the compatibility |
...
```php
getProductCompatibility($sku): \Swagger\EbayInventoryClient\Model\Compatibility
```
