# Swagger\EbayInventoryClient\InventoryItemGroupApi
...
```php
createOrReplaceInventoryItemGroup($content_language, $inventory_item_group_key, $inventory_item_group): \Swagger\EbayInventoryClient\Model\BaseResponse
```
...
$inventory_item_group = new \Swagger\EbayInventoryClient\Model\InventoryItemGroup(); // \Swagger\EbayInventoryClient\Model\InventoryItemGroup | Details of the inventory Item Group
 ...
 **inventory_item_group** | [**\Swagger\EbayInventoryClient\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)| Details of the inventory Item Group |
...
```php
getInventoryItemGroup($inventory_item_group_key): \Swagger\EbayInventoryClient\Model\InventoryItemGroup
```
...
[**\Swagger\EbayInventoryClient\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)
