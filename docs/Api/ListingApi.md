# Swagger\EbayInventoryClient\ListingApi
...
# **bulkMigrateListing**
> \Swagger\EbayInventoryClient\Model\BulkMigrateListingResponse bulkMigrateListing($body)
...
$body = new \Swagger\EbayInventoryClient\Model\BulkMigrateListing(); // \Swagger\EbayInventoryClient\Model\BulkMigrateListing | Details of the listings that needs to be migrated into Inventory
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayInventoryClient\Model\BulkMigrateListing**](../Model/BulkMigrateListing.md)| Details of the listings that needs to be migrated into Inventory |
