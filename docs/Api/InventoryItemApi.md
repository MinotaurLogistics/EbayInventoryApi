# Swagger\EbayInventoryClient\InventoryItemApi
...
> \Swagger\EbayInventoryClient\Model\BulkInventoryItemResponse bulkCreateOrReplaceInventoryItem($body)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayInventoryClient\Model\BulkInventoryItem**](../Model/BulkInventoryItem.md)| Details of the inventories with sku and locale |
...
> \Swagger\EbayInventoryClient\Model\BulkGetInventoryItemResponse bulkGetInventoryItem($body)
...
$body = new \Swagger\EbayInventoryClient\Model\BulkGetInventoryItem(); // \Swagger\EbayInventoryClient\Model\BulkGetInventoryItem | Details of the inventories with sku and locale
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayInventoryClient\Model\BulkGetInventoryItem**](../Model/BulkGetInventoryItem.md)| Details of the inventories with sku and locale |
...
> \Swagger\EbayInventoryClient\Model\BulkPriceQuantityResponse bulkUpdatePriceQuantity($body)
...
$body = new \Swagger\EbayInventoryClient\Model\BulkPriceQuantity(); // \Swagger\EbayInventoryClient\Model\BulkPriceQuantity | Price and allocation details for the given SKU and Marketplace
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\EbayInventoryClient\Model\BulkPriceQuantity**](../Model/BulkPriceQuantity.md)| Price and allocation details for the given SKU and Marketplace |
...
> \Swagger\EbayInventoryClient\Model\BaseResponse createOrReplaceInventoryItem($sku, $content_language, $body)
...
$body = new \Swagger\EbayInventoryClient\Model\InventoryItem(); // \Swagger\EbayInventoryClient\Model\InventoryItem | Details of the inventory item record.
 ...
 **body** | [**\Swagger\EbayInventoryClient\Model\InventoryItem**](../Model/InventoryItem.md)| Details of the inventory item record. |
...
# **getInventoryItem**
> \Swagger\EbayInventoryClient\Model\InventoryItemWithSkuLocaleGroupid getInventoryItem($sku)
...
# **getInventoryItems**
> \Swagger\EbayInventoryClient\Model\InventoryItems getInventoryItems($limit, $offset)
